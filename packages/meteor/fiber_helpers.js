...
//
// It's safe to call queueTask from within a task, but not runTask.
//
...
Meteor._SynchronousQueue = function () {
  ...
  // is an object with field 'task' (the task function to run) and 'fiber' (the
  // Fiber associated with the blocking runTask call that queued it, or null if
  // called from queueTasks).
  self._taskHandles = [];
