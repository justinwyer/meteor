...
_.extend(LiveResultsSet.prototype, {
  ...
  _addObserveHandleAndSendInitialAdds: function (handle) {
    ...
    // If this is called from within the main fiber of a task (eg, from a
    // callback from the poll), this will block! ie, it is NOT SAFE to start an observe from within a callback on an identical observe. However,
    self._taskQueue.runTask(function () {
